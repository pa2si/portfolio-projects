const Privacy = () => {
  return (
    <div className="min-h-svh flex flex-col mx-auto max-w-7xl items-center py-28 px-2 xl:px-0">
      <h1 className="text-3xl mb-10">Datenschutz&shy;erkl&auml;rung</h1>
      <h2 className="mb-6 text-xl">1. Datenschutz auf einen Blick</h2>
      <h3 className="text-xl mt-2 mb-2">Allgemeine Hinweise</h3>{' '}
      <p>
      ...
      <h3 className="text-xl mt-2 mb-2">Datenerfassung auf dieser Website</h3>{' '}
      ...
      <h4 className="text-xl mt-1 mb-1">Wie erfassen wir Ihre Daten?</h4>{' '}
      <p>
      ...
      <h4 className="text-xl mt-1 mb-1">Wof&uuml;r nutzen wir Ihre Daten?</h4>{' '}
      <p>
      ...
      <h2 className="mt-4  mb-6 text-xl">2. Hosting</h2>
      <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
      <h3 className="text-xl mt-2 mb-2">Externes Hosting</h3>{' '}
      <p>
      ...
      <h2 className="mt-4 mb-6 text-xl">
        3. Allgemeine Hinweise und Pflicht&shy;informationen
      </h2>
      <h3 className="text-xl mt-2 mb-2">Datenschutz</h3>{' '}
      <p>
      ...
      <h3 className="text-xl mt-2 mb-2">Hinweis zur verantwortlichen Stelle</h3>{' '}
      <p>
        Die verantwortliche Stelle f&uuml;r die Datenverarbeitung auf dieser
        Website ist:
      </p>{' '}
      <p>Pascal Morgan, Richardstr. 99, 12043 Berlin</p>
      <p>
      ...
      <h3 className="text-xl mt-2 mb-2">Speicherdauer</h3>{' '}
      <p>
      ...
      <h3 className="text-xl mt-2 mb-2">SSL- bzw. TLS-Verschl&uuml;sselung</h3>{' '}
      <p>
      ...
      <h3 className="text-xl mt-2 mb-2">Widerspruch gegen Werbe-E-Mails</h3>{' '}
      <p>
      ...
      <h2 className="mb-6 text-xl">4. Datenerfassung auf dieser Website</h2>
      <h3 className="text-xl mt-2 mb-2">Kontaktformular</h3>{' '}
      <p>
