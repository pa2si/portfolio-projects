  ...
  return (
    ...
    >
      <div className="flex flex-col items-center">
        <h1 className="mb-10 text-3xl">Datenschutz&shy;erkl&auml;rung</h1>
        <h2 className="mb-6 text-xl">1. Datenschutz auf einen Blick</h2>
        <h3 className="mb-2 mt-2 text-xl">Allgemeine Hinweise</h3>{" "}
        <p>
        ...
        <h3 className="mb-2 mt-2 text-xl">Datenerfassung auf dieser Website</h3>{" "}
        <h4 className="mb-1 mt-1 text-xl">
        ...
        <h4 className="mb-1 mt-1 text-xl">Wie erfassen wir Ihre Daten?</h4>{" "}
        <p>
        ...
        <h4 className="mb-1 mt-1 text-xl">Wof&uuml;r nutzen wir Ihre Daten?</h4>{" "}
        <p>
        ...
        <h2 className="mb-6 mt-4 text-xl">2. Hosting</h2>
        <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
        <h3 className="mb-2 mt-2 text-xl">Externes Hosting</h3>{" "}
        <p>
        ...
        <h3 className="mb-2 mt-2 text-xl">Datenschutz</h3>{" "}
        <p>
        ...
        <h3 className="mb-2 mt-2 text-xl">
        ...
        <h3 className="mb-2 mt-2 text-xl">Speicherdauer</h3>{" "}
        <p>
        ...
        <h3 className="mb-2 mt-2 text-xl">Widerspruch gegen Werbe-E-Mails</h3>{" "}
        <p>
        ...
        <h3 className="mb-2 mt-2 text-xl">Kontaktformular</h3>{" "}
        <p>
